...
class ChildrenExcusesFragment : BaseFragment() {

    private val binding by lazy {
        FragmentChildrenExcusesBinding.inflate(layoutInflater)
    }
    ...
    private fun initRecyclerView() {
        //Recycler View
        binding.childrenExcusesRv.apply {
            this.layoutManager =
    ...
    private fun observeData() {
        excusesViewModel.childrenExcuses.observe(viewLifecycleOwner) { state ->
            ...
            when (state) {
                ...
                is UIState.ERROR -> {
                    ...
                    state.error.localizedMessage?.let {
                        showError(it) {
                            excusesViewModel.getChildrenExcuses()
                        }
                    }
                }
                else -> {}
